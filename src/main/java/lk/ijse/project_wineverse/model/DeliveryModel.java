...
public class DeliveryModel {
    ...
    public static boolean update(DeliveryDTO delivery) throws SQLException {
    ...
    public static DeliveryDTO findById(String id) throws SQLException {
    ...
    public static DeliveryDTO findBydeliveryId(String delid) throws SQLException {
