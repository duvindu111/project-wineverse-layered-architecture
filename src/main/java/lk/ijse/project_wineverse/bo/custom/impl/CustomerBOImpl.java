...
public class CustomerBOImpl implements CustomerBO {
    ...
    public boolean saveCustomer(CustomerDTO dto) throws SQLException, ClassNotFoundException {
        return customerDAO.save( new CashierCustomer(dto.getId(), dto.getName(),dto.getEmail(),dto.getContact()));
    }
    ...
    public ArrayList<CustomerDTO> getAllCustomers() throws SQLException {
        ArrayList<CashierCustomer> all = customerDAO.getAll();
    ...
    public CustomerDTO findByCustomerId(String id) throws SQLException {
        CashierCustomer customer = customerDAO.findBy(id);
    ...
    public boolean updateCustomer(CustomerDTO dto) throws SQLException {
        return customerDAO.update(new CashierCustomer(dto.getId(), dto.getName(),dto.getEmail(),dto.getContact()));
    }
