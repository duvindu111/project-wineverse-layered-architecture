...
CREATE TABLE Customer(
                         ...
                         cust_contact VARCHAR(15) UNIQUE NOT NULL,
                         PRIMARY KEY(cust_id)
);
...
CREATE TABLE Delivery(
                         ...
                         delivered_date VARCHAR(10) DEFAULT 'Pending',
                         due_date VARCHAR(10) DEFAULT 'Not Given',
                         order_id VARCHAR(20),
                         emp_id VARCHAR(20),
...
# ALTER TABLE event DROP COLUMN picture ;

# UPDATE event SET picture = null WHERE event_id = 'event-001';
...
ALTER TABLE event_images MODIFY COLUMN image longblob NOT NULL ;
...
# DELETE FROM event_images WHERE event_id = 'event-001';
